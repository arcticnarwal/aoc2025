            ...
            while ((line = reader.readLine()) != null) {
                ...
                for (String productIdRange : productIdRanges) {
                    ...
                    while (currentProductId <= lastProductId) {
                        boolean isInvalidProductId = false;
                        String currentProductIdString = String.valueOf(currentProductId);
                        int divisor = currentProductIdString.length() / 2;
                        
                        while (!isInvalidProductId && divisor > 0) {
                            isInvalidProductId = isRepeatedValue(currentProductIdString.substring(0, divisor), currentProductIdString);
                            divisor--;
                        }
